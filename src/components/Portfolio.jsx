    ...
    <section className="portfolio-section">
      ...
      <div className="portfolio-section__content">
        ...
        <div className="portfolio-section__grid">
          <ProjectItem projectName='todo'/>
          <ProjectItem projectName='learnlogicify'/>
          <ProjectItem projectName='winzee'/>
          <ProjectItem projectName='chatGPT'/>
          <ProjectItem projectName='gemini'/>
        </div>
